...
SELECT 컬럼명1, 컬럼명2, ... 
 FROM 테이블 A 
 INNER JOIN 테이블 B ON 테이블A.조인_컬럼 = 테이블B.조인_컬럼;
...
SELECT 컬럼명1, 컬럼명2, ... 
 FROM 테이블 A 
 LEFT JOIN 테이블 B ON 테이블A.조인_컬럼 = 테이블B.조인_컬럼;
...
SELECT 컬럼명1, 컬럼명2, ... 
FROM 테이블 A 
RIGHT JOIN 테이블 B ON 테이블A.조인_컬럼 = 테이블B.조인_컬럼;
...
SELECT 컬럼명1, 컬럼명2, ... 
FROM 테이블 A 
FULL JOIN 테이블 B ON 테이블A.조인_컬럼 = 테이블B.조인_컬럼;
...
-- (참고) UNION 연산을 활용하면 FULL 조인 결과 생성 가능
